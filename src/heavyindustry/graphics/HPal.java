...
public final class HPal {
	...
	public static final Color
			...
			carbideAmmoBack = Color.valueOf("ab8ec5"),
			goldAmmoBack = Color.valueOf("f8df87"),
			crystalAmmoBack = Color.valueOf("7fd489"),
			crystalAmmoBright = Color.valueOf("96e6a0"),
			crystalAmmoDark = Color.valueOf("62ae7f"),
			uraniumAmmoBack = Color.valueOf("a5b2c2"),
			chromiumAmmoBack = Color.valueOf("8f94b3"),
			...
			leadAmmoBack = Color.valueOf("8c7fa9"),
			leadAmmoFront = Color.white.cpy(),
			titaniumAmmoBack = Color.valueOf("8da1e3"),
