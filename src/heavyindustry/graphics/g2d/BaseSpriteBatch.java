...
public class BaseSpriteBatch extends BaseBatch {
	 ...
	 *
	 * @see #BaseSpriteBatch(int, Shader)
	 */
	 ...
	 * @see #BaseSpriteBatch(int, Shader)
	 */
	public BaseSpriteBatch(int size) {
		this(size, null);
	}
	 ...
	 */
	public BaseSpriteBatch(int size, Shader defaultShader) {
	...
	protected void draw(TextureRegion region, float x, float y, float originX, float originY, float width, float height, float rotation) {
		...
		if (!Mathf.zero(rotation)) {
			...
			float color = colorPacked;
			float mixColor = mixColorPacked;
