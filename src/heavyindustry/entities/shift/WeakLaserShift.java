...
public class WeakLaserShift extends ShiftHandler {
	public WeakLaserShift(String name) {
		...
		panels.addAll(new ShiftPanel() {{
			...
			//widthCurve = a -> Interp.pow2.apply(a * a);
			heightFrom = 0.5f;
			widthCurve = a -> Interp.slope.apply(Interp.pow2Out.apply(a));
