...
import heavyindustry.ui.markdown.elemdraw.DrawHr;
import heavyindustry.ui.markdown.elemdraw.DrawImg;
...
public class BaseDrawRenderer extends AbstractVisitor implements NodeRenderer {
	public static final Set<Class<? extends Node>> typeSet = CollectionObjectSet.with(
			Document.class,
			Heading.class,
			Paragraph.class,
			BlockQuote.class,
	...
	public void visit(Image image) {
		...
		for (String s : Markdown.IMAGE_BASE_64_List) {
