...
import heavyindustry.world.blocks.defense.ConnectedWall;
...
import heavyindustry.world.blocks.defense.turrets.AccelTurret;
...
import heavyindustry.world.blocks.defense.turrets.OverHeatTurret;
...
import heavyindustry.world.blocks.heat.AdvancedHeaterGenerator;
...
import heavyindustry.world.blocks.power.AdjustableBeamNode;
...
import heavyindustry.world.blocks.power.TileGenerator;
...
import heavyindustry.world.blocks.production.BoostDrill;
import heavyindustry.world.blocks.production.ColiderCrafter;
...
import heavyindustry.world.blocks.production.LinkAttributeCrafter;
import heavyindustry.world.blocks.production.LinkGenericCrafter;
...
import heavyindustry.world.draw.DrawFlameRotated;
...
import heavyindustry.world.draw.DrawLiquidRegionRotated;
...
import heavyindustry.world.draw.DrawRegionCenterSymmetry;
import heavyindustry.world.draw.DrawRegionDynamic;
import heavyindustry.world.draw.DrawRegionRotated;
...
final class HClassMap {
	...
	static void load() {
		...
		classes.put("AdaptLiquidBridge", RailLiquidBridge.class);
		classes.put("AdaptLiquidBridgeBuild", RailLiquidBridge.RailLiquidBridgeBuild.class);
