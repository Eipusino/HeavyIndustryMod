...
import heavyindustry.world.blocks.distribution.RailGate;
...
import heavyindustry.world.blocks.distribution.RailStackConveyor;
...
import heavyindustry.world.blocks.production.ImpactDrill;
...
final class HClassMap {
	...
	static void load() {
		...
		classes.put("RailDirectionalGate", RailDirectionalGate.class);
		classes.put("RailDirectionalGateBuild", RailDirectionalGate.RailDirectionalGateBuild.class);
		classes.put("RailDirectionalMerger", RailDirectionalMerger.class);
		classes.put("RailDirectionalMergerBuild", RailDirectionalMerger.RailDirectionalMergerBuild.class);
		classes.put("RailDirectionalRouter", RailDirectionalRouter.class);
		classes.put("RailDirectionalRouterBuild", RailDirectionalRouter.RailDirectionalRouterBuild.class);
		...
		classes.put("RailGate", RailGate.class);
		classes.put("RailGateBuild", RailGate.RailGateBuild.class);
		classes.put("RailItemBridge", RailItemBridge.class);
		classes.put("RailItemBridgeBuild", RailItemBridge.RailItemBridgeBuild.class);
		classes.put("RailStackConveyor", RailStackConveyor.class);
		classes.put("RailStackConveyorBuild", RailStackConveyor.RailStackConveyorBuild.class);
		...
		classes.put("LogisticsDuctJunctionBuild", AdaptDuctJunction.LogisticsDuctJunctionBuild.class);
		...
		classes.put("ImpactDrill", ImpactDrill.class);
		classes.put("ImpactDrilllBuild", ImpactDrill.ImpactDrillBuild.class);
