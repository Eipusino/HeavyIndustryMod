...
final class HClassMap {
	...
	static void load() {
		...
		classes.put("DPSWallDisplay", DPSWallDisplay.class);
		classes.put("DPSWallDisplayBuild", DPSWallDisplay.DPSWallDisplayBuild.class);
		...
		classes.put("AdaptDuctJunction", AdaptDuctJunction.class);
		classes.put("AdaptDuctJunctionBuild", AdaptDuctJunction.AdaptDuctJunctionBuild.class);
