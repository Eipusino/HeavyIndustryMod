...
import heavyindustry.world.blocks.distribution.DirectionalGate;
import heavyindustry.world.blocks.distribution.DirectionalMerger;
import heavyindustry.world.blocks.distribution.Gate;
...
final class HClassMap {
	...
	static void load() {
		...
		classes.put("DirectionalGate", DirectionalGate.class);
		classes.put("DirectionalGateBuild", DirectionalGate.DirectionalGateBuild.class);
		...
		classes.put("Gate", Gate.class);
		classes.put("GateBuild", Gate.GateBuild.class);
