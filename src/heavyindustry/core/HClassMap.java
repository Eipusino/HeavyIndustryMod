...
import heavyindustry.world.blocks.distribution.XFConveyor;
import heavyindustry.world.blocks.distribution.XFDirectionalGate;
import heavyindustry.world.blocks.distribution.XFDirectionalMerger;
import heavyindustry.world.blocks.distribution.XFDirectionalRouter;
import heavyindustry.world.blocks.distribution.XFDirectionalUnloader;
import heavyindustry.world.blocks.distribution.XFGate;
import heavyindustry.world.blocks.distribution.XFItemBridge;
import heavyindustry.world.blocks.distribution.XFStackConveyor;
...
final class HClassMap {
	...
	static void load() {
		...
		classes.put("XFConveyor", XFConveyor.class);
		classes.put("XFConveyorBuild", XFConveyor.XFConveyorBuild.class);
		classes.put("XFDirectionalGate", XFDirectionalGate.class);
		classes.put("XFDirectionalGateBuild", XFDirectionalGate.XFDirectionalGateBuild.class);
		classes.put("XFDirectionalMerger", XFDirectionalMerger.class);
		classes.put("XFDirectionalMergerBuild", XFDirectionalMerger.XFDirectionalMergerBuild.class);
		classes.put("XFDirectionalRouter", XFDirectionalRouter.class);
		classes.put("XFDirectionalRouterBuild", XFDirectionalRouter.XFDirectionalRouterBuild.class);
		classes.put("XFDirectionalUnloader", XFDirectionalUnloader.class);
		classes.put("XFDirectionalUnloaderBuild", XFDirectionalUnloader.XFDirectionalUnloaderBuild.class);
		classes.put("XFGate", XFGate.class);
		classes.put("XFGateBuild", XFGate.XFGateBuild.class);
		classes.put("XFItemBridge", XFItemBridge.class);
		classes.put("XFItemBridgeBuild", XFItemBridge.XFItemBridgeBuild.class);
		classes.put("XFStackConveyor", XFStackConveyor.class);
		classes.put("XFStackConveyorBuild", XFStackConveyor.XFStackConveyorBuild.class);
		classes.put("XLDirectionalUnloader", XLDirectionalUnloader.class);
		classes.put("XLDirectionalUnloaderBuild", XLDirectionalUnloader.XLDirectionalUnloaderBuild.class);
		...
		classes.put("XCDuctJunction", XCDuctJunction.class);
		classes.put("XCDuctJunctionBuild", XCDuctJunction.XCDuctJunctionBuild.class);
