...
public class ExtraUnitWaterMove extends UnitWaterMove implements ExtraUnitc {
	protected ExtraUnitWaterMove() {}
	...
	public static ExtraUnitWaterMove create() {
		return new ExtraUnitWaterMove();
	}
}
