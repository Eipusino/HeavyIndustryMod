...
public class ExtraTimedKillUnit extends TimedKillUnit implements ExtraUnitc {
	protected ExtraTimedKillUnit() {}

	@Override
	public int classId() {
		return EntityRegister.getId(ExtraTimedKillUnit.class);
	}
	...
	public static ExtraTimedKillUnit create() {
		return new ExtraTimedKillUnit();
	}
}
