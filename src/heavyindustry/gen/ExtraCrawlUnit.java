...
public class ExtraCrawlUnit extends CrawlUnit {
	protected ExtraCrawlUnit() {}

	@Override
	public int classId() {
		return EntityRegister.getId(ExtraCrawlUnit.class);
	}
	...
	public static ExtraCrawlUnit create() {
		return new ExtraCrawlUnit();
	}
}
