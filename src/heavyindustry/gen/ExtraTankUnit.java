...
public class ExtraTankUnit extends TankUnit implements ExtraUnitc {
	protected ExtraTankUnit() {}

	@Override
	public int classId() {
		return EntityRegister.getId(ExtraTankUnit.class);
	}
	...
	public static ExtraTankUnit create() {
		return new ExtraTankUnit();
	}
}
