...
public class CrawlUnitf extends CrawlUnit {
	protected CrawlUnitf() {}

	@Override
	public int classId() {
		return EntityRegister.getId(CrawlUnitf.class);
	}
	...
	public static CrawlUnitf create() {
		return new CrawlUnitf();
	}
}
