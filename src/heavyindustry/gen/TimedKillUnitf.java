...
public class TimedKillUnitf extends TimedKillUnit {
	protected TimedKillUnitf() {}

	@Override
	public int classId() {
		return EntityRegister.getId(TimedKillUnitf.class);
	}
	...
	public static TimedKillUnitf create() {
		return new TimedKillUnitf();
	}
}
