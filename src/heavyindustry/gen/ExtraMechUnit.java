...
public class ExtraMechUnit extends MechUnit implements ExtraUnitc {
	protected ExtraMechUnit() {}

	@Override
	public int classId() {
		return EntityRegister.getId(ExtraMechUnit.class);
	}
	...
	public static ExtraMechUnit create() {
		return new ExtraMechUnit();
	}
}
