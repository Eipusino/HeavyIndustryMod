...
public class ExtraLegsUnit extends LegsUnit implements ExtraUnitc {
	protected ExtraLegsUnit() {}

	@Override
	public int classId() {
		return EntityRegister.getId(ExtraLegsUnit.class);
	}
	...
	public static ExtraLegsUnit create() {
		return new ExtraLegsUnit();
	}
}
