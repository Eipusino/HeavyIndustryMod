...
public final class HIBullets {
    ...
    public static void load() {
        ...
        vastBulletAccel = new AccelBulletType(2f, 180f) {{
            ...
            trailWidth = 3f;
            lifetime = 160f;
            trailEffect = HIFx.trailFromWhite;
            pierceArmor = true;
            trailRotation = false;
            trailChance = 0.35f;
            trailParam = 4f;
            ...
            public void hit(Bullet b, float x, float y) {
                ...
                HIFx.chainLightningFade.at(b.x, b.y, Mathf.random(12, 20), b.team.color, from);
                from.heal(damage / 8);
            }
        ...
        vastBulletLightningBall = new LightningLinkerBulletType(3f, 120) {{
            ...
            despawnEffect = hitEffect = new MultiEffect(HIFx.lightningHitLarge, HIFx.hitSparkHuge);
            trailEffect = slopeEffect = HIFx.trailFromWhite;
            ...
            public final Effect RsmokeEffect = HIFx.hitSparkLarge;
            ...
            public void update(Bullet b) {
                ...
                if (randomGenerateRange > 0f && Mathf.chance(Time.delta * randomGenerateChance) && b.lifetime - b.time > PositionLightning.lifetime) PositionLightning.createRandomRange(b, b.team, b, randomGenerateRange, backColor, Mathf.chanceDelta(randomLightningChance), 0, 0, boltWidth, boltNum, randomLightningNum, hitPos -> {
                    ...
                    HIFx.lightningHitLarge.at(hitPos.getX(), hitPos.getY(), b.team.color);
                ...
                if (Mathf.chanceDelta(effectLightningChance) && b.lifetime - b.time > Fx.chainLightning.lifetime) {
                    for (int i = 0; i < effectLingtning; i++) {
                        ...
                        HIFx.lightningHitSmall.at(v.x, v.y, 20f, b.team.color);
                    }
                }
            }
