...
public class DirectionalGate extends OverflowDuct {
	public TextureRegion baseRegion, overlayRegion, invertRegion;

	public DirectionalGate(String name) {
		super(name);
		...
		config(Boolean.class, (DirectionalGateBuild build, Boolean invert) -> build.invert = invert);
	}
	...
	public class DirectionalGateBuild extends OverflowDuctBuild {
