 ...
 */
public class CollectionObjectMap<K, V> implements Iterable<CollectionObjectMap.MapEntry<K, V>>, BaseMap<K, V> {
	...
	@Override
	public V asComputeIfAbsent(K key, Func<? super K, ? extends V> mappingFunction) {
		V v;
		if ((v = get(key)) == null) {
			V newValue;
