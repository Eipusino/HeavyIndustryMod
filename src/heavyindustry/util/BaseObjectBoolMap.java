...
public class BaseObjectBoolMap<K> implements Iterable<BaseObjectBoolMap.MapEntry<K>> {
	 ...
	 */
	public BaseObjectBoolMap(Class<?> keyType, int initialCapacity) {
	...
	public BaseObjectBoolMap(Class<?> keyType, int initialCapacity, float loadFactor) {
	...
	public BaseObjectBoolMap(BaseObjectBoolMap<? extends K> map) {
	...
	public void putAll(BaseObjectBoolMap<? extends K> map) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof BaseObjectBoolMap<?> map) || map.keyComponentType != keyComponentType) return false;
		BaseObjectBoolMap<K> other = (BaseObjectBoolMap<K>) map;
	...
	private static class MapIterator<K> {
		...
		public MapIterator(BaseObjectBoolMap<K> map) {
			this.map = map;
			reset();
		}
	...
	public static class Values extends MapIterator<Object> {
		@SuppressWarnings("unchecked")
		public Values(BaseObjectBoolMap<?> map) {
			super((BaseObjectBoolMap<Object>) map);
		}
	...
	public static class Keys<K> extends MapIterator<K> implements Iterable<K>, Iterator<K> {
		public Keys(BaseObjectBoolMap<K> map) {
			super(map);
		}
