...
public class JarList {
    ...
    public Fi loadCacheFile(ModInfo mod) {
        if (!selfUpdate && mod.name.equals("heavy-industry")) {
            if (!matched(mod)) {
                selfUpdate = true;
                ...
                for (Fi fi : Vars.modDirectory.list()) {
                    try {
                        ...
                        if (!info.name.equals("heavy-industry") && !matched(info)) {
                            selfUpdate = true;
        ...
        InfoEntry entry = list.get(mod.name);
        if (entry == null) {
            if (mod.name.equals("heavy-industry")) recached = true;
            ...
            writeToList();
        } else if ((selfUpdate && mod.name.equals("heavy-industry") && !recached) || !matched(mod)) {
            if (mod.name.equals("heavy-industry")) recached = true;
