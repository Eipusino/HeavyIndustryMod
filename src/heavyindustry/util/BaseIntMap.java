...
public class BaseIntMap<V> implements Iterable<BaseIntMap.Entry<V>> {
	...
	public static <V> BaseIntMap<V> of(Class<V> keyType, Object... values) {
		BaseIntMap<V> map = new BaseIntMap<>(keyType);
	...
	public BaseIntMap(Class<?> keyType) {
	 ...
	 */
	public BaseIntMap(int initialCapacity, Class<?> keyType) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public BaseIntMap(int initialCapacity, float loadFactor, Class<?> keyType) {
	...
	public void putAll(BaseIntMap<? extends V> map) {
	...
	private static class MapIterator<V> {
		...
		public MapIterator(BaseIntMap<V> map) {
			this.map = map;
			reset();
		}
	...
	public static class Entries<V> extends MapIterator<V> implements Iterable<Entry<V>>, Iterator<Entry<V>> {
		...
		public Entries(BaseIntMap<V> map) {
			super(map);
		}
	...
	public static class Values<V> extends MapIterator<V> implements Iterable<V>, Iterator<V> {
		public Values(BaseIntMap<V> map) {
			super(map);
		}
