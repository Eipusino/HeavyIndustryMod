...
public final class Reflectf {
    ...
    public static <T> Constructor<T> constructor(Class<T> type, Class<?>... args) {
        return constructor(type, true, args);
    }

    /** A utility function to find a constructor without throwing exceptions. */
    public static <T> Constructor<T> constructor(Class<T> type, boolean access, Class<?>... args) {
        try {
    ...
    public static <T> T newInstance(Class<T> type) {
        return newInstance(constructor(type, true));
    }
