...
public class BaseLongMap<V> implements Iterable<BaseLongMap.Entry<V>> {
	...
	public BaseLongMap(Class<?> keyType) {
	 ...
	 */
	public BaseLongMap(int initialCapacity, Class<?> keyType) {
	...
	public BaseLongMap(int initialCapacity, float loadFactor, Class<?> keyType) {
	...
	public void putAll(BaseLongMap<? extends V> map) {
	...
	private static class MapIterator<V> {
		...
		public MapIterator(BaseLongMap<V> map) {
			this.map = map;
			reset();
		}
	...
	public static class Entries<V> extends MapIterator<V> implements Iterable<Entry<V>>, Iterator<Entry<V>> {
		...
		public Entries(BaseLongMap<V> map) {
			super(map);
		}
	...
	public static class Values<V> extends MapIterator<V> implements Iterable<V>, Iterator<V> {
		public Values(BaseLongMap<V> map) {
			super(map);
		}
