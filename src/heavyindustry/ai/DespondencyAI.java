...
import heavyindustry.type.weapons.EndDespondencyWeapon.DespondencyMount;
import heavyindustry.util.HierarchyArray;
...
public class DespondencyAI extends AIController {
	...
	public HierarchyArray<Teamc> targets = new HierarchyArray<>(8, Teamc.class);
	public boolean death;
	public float deathTime = 0f;
	public float reloadTime = 0f;
	public float distractionTime = 0f;
	public boolean altTarget = false;
