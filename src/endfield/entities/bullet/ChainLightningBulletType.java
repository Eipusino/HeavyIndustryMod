...
public class ChainLightningBulletType extends BulletType {
	...
	public void init(Bullet b) {
		...
		for (int i = 0; i < builds; i++) {
			...
			Fx2.chainLightning.at(Tmp.v1.x, Tmp.v1.y, 0, lightningColor, new LightningHolder(b, Tmp.v1));
	...
	public class LightningHolder implements Fx2.VisualLightningHolder {
