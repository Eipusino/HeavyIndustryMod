...
public class PositionLightningBulletType extends BulletType {
	...
	public PositionLightningBulletType(float damage) {
		...
		hitEffect = shootEffect = smokeEffect = Fx2.boolSelector;
	...
	public void init() {
		...
		if (hitEffect == Fx2.boolSelector) hitEffect = Fx2.lightningHitLarge(lightningColor);
		if (smokeEffect == Fx2.boolSelector) smokeEffect = Fx.shootBigSmoke;
		if (shootEffect == Fx2.boolSelector) shootEffect = Fx2.shootLineSmall(lightningColor);
	}
