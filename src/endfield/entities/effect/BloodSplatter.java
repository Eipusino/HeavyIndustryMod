...
public class BloodSplatter extends BaseEntity implements Poolable {
	public float x1, y1, x2, y2;
	public float length;
	public float angle;
	public float size;
	public float time = 0f, lifetime = 0f, lifetime2;
	public float randColor = 1f;
	//Color color = FlamePal.blood;
	public Color color = new Color(Pal2.blood);
	//PowOut out = new PowOut(2);
	public DynamicPowOut out = new DynamicPowOut();

	public static float vx = 0f, vy = 0f;
	public static float baseLifetime = 15f * 60f;
	...
	public static void explosion(int amount, float x, float y, float boundary, float length, float size) {
		explosion(amount, x, y, boundary, length, size, 35f, Pal2.blood, 0.2f);
	}
	...
	public static void create(float x, float y, float x2, float y2, float lifetime, float size) {
		create(x, y, x2, y2, lifetime, size, Pal2.blood, 0.2f);
	}
	...
	public void draw() {
		...
		if (fin2 < 1) {
			...
			Drawn.tri(Tmp.v1.x, Tmp.v1.y, Tmp.v2.x, Tmp.v2.y, width * out2, angle);
	...
	public static class DynamicPowOut implements IInterp {
