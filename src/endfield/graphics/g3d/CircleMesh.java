...
public class CircleMesh extends PlanetMesh {
	...
	public void preRender(PlanetParams params) {
		Shaders2.planetTexture.planet = planet;
		Shaders2.planetTexture.lightDir.set(planet.solarSystem.position).sub(planet.position).rotate(Vec3.Y, planet.getRotation()).nor();
		Shaders2.planetTexture.ambientColor.set(planet.solarSystem.lightColor);
		//TODO better disappearing
		Shaders2.planetTexture.alpha = params.planet == planet ? 1f - params.uiAlpha : 1f;
	}
