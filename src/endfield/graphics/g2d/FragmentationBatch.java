...
import endfield.entities.effect.Fragmentation;
import endfield.entities.effect.Fragmentation.FragmentEntity;
...
public class FragmentationBatch extends BaseBatch {
	...
	public Cons<? super FragmentEntity> fragCons = e -> {}, onDeathCons = null;
	public Cons<? super Fragmentation> fragDataCons = null;
	public AltFragCons altCons = (x, y, tex) -> {};
	...
	protected void draw(TextureRegion region, float x, float y, float originX, float originY, float width, float height, float rotation) {
		...
		if (dim >= (4 * 32) || !useAlt) {
			...
			frag.onDeath = onDeathCons;
			if (fragDataCons != null) fragDataCons.get(frag);
		} else {
			altCons.frag(bx, by, region);
		}
	}
