	...
	public AuroraType(String name) {
		...
		weapons.addAll(new Weapon(this.name + "-lightcone") {{
			...
			parts.addAll(new CustomPart() {{
				...
				draw = (x, y, r, p) -> {
					Lines.stroke(p * 1.6f, Pal2.matrixNet);
			...
			ejectEffect = Fx2.railShootRecoil;
			recoilTime = 30;
			shake = 4;
			...
			bullet = new ContinuousLaserBulletType() {{
				...
				width = 6;
				hitColor = Pal2.matrixNet;
				shootEffect = Fx2.explodeImpWave;
				chargeEffect = Fx2.auroraCoreCharging;
			...
			alternativeBullet = new BulletType() {{
				...
				homingPower = 0.25f;
				hitColor = Pal2.matrixNet;
				hitEffect = new MultiEffect(Fx2.explodeImpWave, Fx2.diamondSpark);

				trailLength = 32;
				trailWidth = 3;
				trailColor = Pal2.matrixNet;
				trailEffect = new MultiEffect(Fx2.movingCrystalFrag, Fx.colorSparkBig);
				trailRotation = true;
				trailInterval = 4;
				...
				fragBullet = new BulletType() {{
					...
					hitEffect = new MultiEffect(
							Fx2.explodeImpWaveSmall,
							Fx2.diamondSpark
					);
					hitColor = Pal2.matrixNet;

					trailColor = Pal2.matrixNet;
					trailEffect = Fx2.glowParticle;
					trailRotation = true;
					trailInterval = 15f;
				...
				public void hitEntity(Bullet b, Hitboxc entity, float health) {
					if (entity instanceof Unit unit && unit.shield > 0) {
						...
						Fx.colorSparkBig.at(b.x, b.y, b.rotation(), Pal2.matrixNet);
					}
			...
			public void draw(Unit unit, WeaponMount mount) {
				...
				Lines.stroke(1.6f * (mount.charging ? 1 : mount.warmup * (1 - mount.recoil)), Pal2.matrixNet);
