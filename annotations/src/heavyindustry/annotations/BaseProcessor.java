...
public abstract class BaseProcessor implements Processor {
	...
	public static final String packageFetch = "heavyindustry.fetch";
	...
	public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
		...
		if (roundEnv.processingOver())
			Log.info("Time taken for @: @s", getClass().getSimpleName(), (Time.millis() - initTime) / 1000f);
		return true;
	}
	...
	protected void write(TypeSpec.Builder builder, Seq<String> imports) throws IOException {
		...
		if (imports == null || imports.isEmpty()) {
			...
			Seq<String> result = new Seq<>(String.class);
			...
			try (Writer stream = object.openWriter()) {
